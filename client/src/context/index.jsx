...
export const GlobalContextProvider = ({ children }) => {
    ...
    useEffect(() => {
        ...
        if (battlegroundFromLocalStorage) {
            ...
            localStorage.getItem('battleground',battleGround)
        }
    }) 
    ...
    useEffect(() => {
        if (step !== -1 && contract) {
            createEventListeners({
                navigate, contract, provider, walletAddress, setShowAlert, battleName, setBattleName,setUpdateGameData, player1Ref,player2Ref
            })
        }
    }, [contract,step])
